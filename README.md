...
In this [homework](https://github.com/DataTalksClub/mlops-zoomcamp/blob/main/cohorts/2025/06-best-practices/homework.md), we'll take the ride duration prediction model
...
if __name__ == "__main__":
    # Call your main function here, e.g., main(year, month)
``` 
...
[run_integration_test.sh](run_integration_test.sh)
